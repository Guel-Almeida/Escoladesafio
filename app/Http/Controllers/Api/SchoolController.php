 ...
 *  @OA\Response(
     ...
     *          @OA\JsonContent(
     *              @OA\Property(property="status", type="string", example="Success"),
     *              @OA\Property(property="message", type="string", example="File imported successfully")
     *          )
     *      ),
 * @OA\Response(
     *          response=400,
     ...
     *          @OA\JsonContent(
     *              @OA\Property(property="status", type="string", example="Error"),
     *              @OA\Property(property="message", type="string", example="Bad request. Invalid file format or missing file")
     *          )
     *      ),
 * )
 */
    public function import(Request $request)
    {
        ...
        return response()->json(['status'=>'Success','message'=>'File imported successfully'],Response::HTTP_NO_CONTENT);
